...
When('api kirim 1x order 1 produk ditolak semua oleh super', async function () {

    console.log('api kirim order 1 produk ditolak semua oleh super')
...
When('api kirim 1x order 1 produk ditolak semua oleh customer', async function () {

    console.log('api kirim order 1 produk ditolak semua oleh customer')
