...
When('api kirim 1x order 4 produk ditolak sebagian oleh super', async function () {

    console.log('api kirim order 4 produk ditolak sebagian oleh super')
...
When('api kirim 1x order 4 produk ditolak sebagian oleh customer', async function () {

    console.log('api kirim order 4 produk ditolak sebagian oleh customer')
