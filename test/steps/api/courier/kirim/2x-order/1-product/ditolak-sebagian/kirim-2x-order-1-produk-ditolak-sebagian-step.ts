...
When('api courier user kirim 2x order 1 product ditolak sebagian super', async function () {

    console.log('api courier user kirim 2x order 1 product ditolak sebagian super')
...
When('api courier user kirim 2x order 1 product ditolak sebagian customer', async function () {

    console.log('api courier user kirim 2x order 1 product ditolak sebagian customer')
