...
When('api kirim 2x order 4 produk ditolak sebagian oleh super', async function () {

    console.log('api kirim 2x order 4 produk ditolak sebagian oleh super')
...
When('api kirim 2x order 4 produk ditolak sebagian oleh customer', async function () {

    console.log('api kirim 2x order 4 produk ditolak sebagian oleh customer')
