...
When('api kirim 2x order 4 produk ditolak semua oleh super', async function () {

    console.log('api kirim 2x order 4 produk ditolak semua oleh super')
...
When('api kirim 2x order 4 produk ditolak semua oleh customer', async function () {

    console.log('api kirim 2x order 4 produk ditolak semua oleh customer')
