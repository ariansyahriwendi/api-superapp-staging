...
When('api courier user kirim 2x order 4 product ditolak semua super', async function () {

    console.log('api courier user kirim 2x order 4 product ditolak semua super')
        ...
        orders: [
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        reject_quantity: this.first_order_second_product_quantity,
                        reject_from: 1
                    },
                    {
                        order_item_id: this.first_order_third_product_order_item_id,
                        reject_quantity: this.first_order_third_product_quantity,
                        reject_from: 1
                    },
                    {
                        order_item_id: this.first_order_fourth_product_order_item_id,
                        reject_quantity: this.first_order_fourth_product_quantity,
                        reject_from: 1
                    }
                ]
            },
            {
                ...
                items: [
                    ...
                    {
                        order_item_id: this.second_order_second_product_order_item_id,
                        reject_quantity: this.second_order_second_product_quantity,
                        reject_from: 1
                    },
                    {
                        order_item_id: this.second_order_third_product_order_item_id,
                        reject_quantity: this.second_order_third_product_quantity,
                        reject_from: 1
                    },
                    {
                        order_item_id: this.second_order_fourth_product_order_item_id,
                        reject_quantity: this.second_order_fourth_product_quantity,
                        reject_from: 1
                    }
                ]
            }
...
When('api courier user kirim 2x order 4 product ditolak semua customer', async function () {

    console.log('api courier user kirim 2x order 4 product ditolak semua customer')
